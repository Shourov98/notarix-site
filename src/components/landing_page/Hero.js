      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-12">
            <Link href="/request-access?contactType=client" className="bg-[#4169e1] hover:bg-[#3152c7] text-white px-8 py-3.5 rounded-lg font-semibold text-base transition-colors shadow-lg shadow-blue-100 text-center">
              Get Started as Client
            </Link>
            <Link href="/request-access?contactType=notary" className="bg-white border border-zinc-300 hover:bg-zinc-50 text-zinc-900 px-8 py-3.5 rounded-lg font-semibold text-base transition-colors text-center">
              Join as Notary
            </Link>
          </div>
