    ...
    <section className="bg-white py-24 px-6 md:px-12 lg:px-24">
      <div className="max-w-6xl mx-auto">
        <div className="bg-[#1a4fdb] rounded-[40px] py-20 px-8 md:px-16 text-center text-white shadow-2xl shadow-blue-200">
          ...
          <Link href="/request-access?contactType=client" className="inline-flex bg-white text-[#1a4fdb] px-10 py-4 rounded-xl font-bold text-lg hover:bg-blue-50 transition-colors shadow-lg">
            Get Started Now
          </Link>
        </div>
      </div>
